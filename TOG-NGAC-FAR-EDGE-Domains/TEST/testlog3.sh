...
curl -v -H "Authorization: OAuth ${mytoken}" -H "Content-Type: text/plain"   -XPOST http://${server}:${execmanager_port}/new_log?code=111\&ip="1.1.1.1"\&message="Testagain"\&user="rjd@tog.org" --libcurl log.c;
