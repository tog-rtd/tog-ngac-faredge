...
curl -v -H "Authorization: OAuth ${mytoken}" -H "Content-Type: text/plain"   -XPOST http://httpbin.org/get?code=111\&ip="10.11.12.14"\&message="Testagain"\&user="r.delong@opengroup.org";
