% this file is deprecated, see pdp_test.pl
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% self_test
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
spld_startup_tests([tc01,tc02,tc03,tc04,tc05,tc06,tc07,tc08,
...
spld_regression_tests([]).

self_test :-
	spld_startup_tests(Tests),
	forall(member(T,Tests), test:report_test(spld:T)).

regression_test :-
	spld_startup_tests(Startup),
	spld_regression_tests(Regression),
	append(Startup,Regression,AllTests),
	forall(member(T,AllTests), test:report_test(spld:T)).
...
tc45 :- compose_policies('Policy (a)','Policy (b)','Policy (ab)').
...
% thest 70s and 80s tests assume p_uo variant of 'all'
...
tcvc00 :- compose_policies('Signals Access Policy','Vehicle Ownership Policy','Vehicle Combined Policy').
