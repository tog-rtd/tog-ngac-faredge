...
curl -G "http://127.0.0.1:8001/paapi/readpol" --data-urlencode "policy=ipolicy" --data-urlencode "token=admin_token"
...
curl -G "http://127.0.0.1:8001/paapi/readpol" --data-urlencode "token=admin_token"
